...
while True:
  try:
    url = (
        URL
        + f"getUpdates?timeout=10&offset={last_update_id if last_update_id else 0}"
    )
      ...
      for update in updates["result"]:
        ...
        if "callback_query" in update:
          ...
          user_info = (
              ...
              else f"{user.get('first_name', '')} (ID: {cb_from_id})"
          )
          ...
          if cb_data.startswith("reply_user:"):
            ...
            send_api(
                "sendMessage",
                {
                    "chat_id": cb_from_id,
                    "text": (
                        "✍️ Javobingizni (matn, rasm, video, fayl yoki"
            ...
            send_api(
                "sendMessage",
                {
                    ...
                    "text": (
                        ...
                        f" Qo'yilgan baho: {stars_count}/10 yulduz"
                    ),
                },
            )
            ...
            send_json_api(
                "editMessageText",
                {
                    ...
                    "text": (
                        "✅ Bahoingiz uchun rahmat! Siz"
                        f" {stars_count}⭐️ qo'ydingiz."
                    ),
                },
            )
        ...
        if "message" in update:
          ...
          user_info = (
              f"@{user.get('username')}"
              if user.get("username")
              else f"{user.get('first_name', '')} (ID: {chat_id})"
          )
          ...
          keyboard = json.dumps({
              "keyboard": [
                  ...
                  [
                      {"text": "🛍 Zakaz qilish"},
                      {"text": "🔍 Zapchast bor/yo'qligini bilish"},
                  ],
                  [
                      {"text": "🔥 Chegirmalar"},
                  ...
                  [
                      {"text": "⭐️ Mijozlar fikrlari"},
                      {"text": "✍️ Shikoyat qilish"},
                  ],
                  [
                      {"text": "📢 Kanalga reklama qo'yish"},
          ...
          if current_state and str(current_state).startswith("replying_to_"):
            ...
            send_api(
                "sendMessage",
                {"chat_id": target_chat_id, "text": "💬 Sizga yangi xabar keldi:"},
            )
            res = send_json_api(
                "copyMessage",
                {
          ...
          if chat_id == ADMIN_ID and "reply_to_message" in msg:
            ...
            if replied_msg_id in admin_reply_tracker:
              ...
              reply_btn = json.dumps({
                  "inline_keyboard": [[{
                      "text": "💬 Javob berish",
                      "callback_data": f"reply_user:{ADMIN_ID}",
                  }]]
              })
              ...
              if res.get("ok"):
                ...
                send_api(
                    "sendMessage",
                    {"chat_id": ADMIN_ID, "text": "❌ Javob yetkazilmadi."},
                )
              continue
          ...
          if current_state == "waiting_for_ad":
            ...
            if res.get("ok"):
              ...
              send_api(
                  ...
                  {
                      "chat_id": chat_id,
                      "text": "❌ Xatolik! Botni kanalga admin qiling.",
                      "reply_markup": keyboard,
                  },
              )
            user_states[chat_id] = None
            ...
            send_api(
                "sendMessage",
                {
                    "chat_id": chat_id,
                    "text": (
                        "✅ So'rovingiz va yuborgan fayllaringiz qabul"
                        " qilindi!"
                    ),
                    "reply_markup": keyboard,
                },
            ...
            send_api(
                ...
                {
                    "chat_id": chat_id,
                    "text": "✅ Shikoyat / taklifingiz adminga yetkazildi!",
                    "reply_markup": keyboard,
                },
            )
            user_states[chat_id] = None
          ...
          if text == "/start":
            ...
            start_msg = (
                "Assalomu Alaykum! LADA CROSS botiga xush kelibsiz. Kerakli"
                " bo'limni tanlang:"
            )
            send_api(
                "sendPhoto",
            ...
            send_api(
                ...
                {
                    "chat_id": chat_id,
                    "text": "📞 Manager: SOLLIHONAKA\nTelefon: +998905077266",
                    "reply_markup": keyboard,
                },
            )
            ...
            send_api(
                "sendMessage",
                {
                    "chat_id": chat_id,
                    "text": (
                        "ℹ️ LADA CROSS ZAPCHAST do'koni.\nBarcha turdagi Lada"
                        " avtomashinalari ehtiyot qismlari arzon narxlarda"
                        " sotiladi. Barcha zapchastlarimizga 100% kafolat"
                        " beriladi!"
                    ),
                    "reply_markup": keyboard,
                },
            ...
            send_api(
                "sendMessage",
                {
                    "chat_id": chat_id,
                    "text": (
                        "🔥 Hozirgi kunda mavjud bo'lgan chegirmalar va"
                        " aksiyalar haqida ma'lumot olish uchun rasmiy"
                        " kanalimizni kuzatib bering:\nhttps://t.me/Lada_cross7"
                    ),
                    "reply_markup": keyboard,
                },
            )
            ...
            send_api(
                "sendMessage",
                {
                    "chat_id": chat_id,
                    "text": (
                        "🚚 Dastavka / Yetkazib berish xizmati bor!\nO'zbekiston"
                        " bo'ylab pochta yoki taksi orqali tezkor yetkazib"
                        " beramiz. Batafsil ma'lumot uchun menejer bilan"
                        " bog'laning."
                    ),
                    "reply_markup": keyboard,
                },
            ...
            send_api(
                "sendMessage",
                {
                    ...
                    "text": (
                        "💳 To'lov turlari:\n• Naqd pul\n• Click / Payme (Karta"
                        " orqali)\n• Joyida to'lov qilishingiz mumkin."
                    ),
                    "reply_markup": keyboard,
                },
            )
            ...
            faq_text = (
                ...
                " originalmi?\n— Ha, barcha zapchastlarimiz sifatli va"
            ...
            send_api(
                "sendMessage",
                {
                    "chat_id": chat_id,
                    "text": (
                        "⭐️ Mijozlarimizning fikrlari va izohlarini"
                        " kanalimizda ko'rishingiz"
                        " mumkin:\nhttps://t.me/Lada_cross7"
                    ),
                    "reply_markup": keyboard,
                },
            ...
            send_api(
                "sendMessage",
                {
                    "chat_id": chat_id,
                    "text": (
                        "✍️ Shikoyat yoki taklifingizni yuboring (Matn, rasm,"
                        " video yoki audio shaklida):"
                    ),
            ...
            send_api(
                ...
                {
                    "chat_id": chat_id,
                    "text": "Reklama matni, rasm yoki videongizni yuboring:",
                    "reply_markup": cancel_keyboard,
                },
            )
            ...
            send_api(
                "sendMessage",
                {
                    "chat_id": chat_id,
                    "text": (
                        "Kerakli zapchast rasmi, nomi yoki videosini yuboring:"
                    ),
                    "reply_markup": cancel_keyboard,
                },
            )
            ...
            send_api(
                "sendMessage",
                {
                    "chat_id": chat_id,
                    "text": (
                        "Zakaz qilmoqchi bo'lgan buyumingiz rasm/videosi yoki"
                        " nomini yuboring:"
                    ),
                    "reply_markup": cancel_keyboard,
                },
            ...
            rating_keyboard = json.dumps({
                "inline_keyboard": [[
                    {"text": "1⭐️", "callback_data": "rate_1"},
                    {"text": "2⭐️", "callback_data": "rate_2"},
                    {"text": "3⭐️", "callback_data": "rate_3"},
                    {"text": "4⭐️", "callback_data": "rate_4"},
                    {"text": "5⭐️", "callback_data": "rate_5"},
                ], [
                    {"text": "6⭐️", "callback_data": "rate_6"},
                    {"text": "7⭐️", "callback_data": "rate_7"},
                    {"text": "8⭐️", "callback_data": "rate_8"},
                    {"text": "9⭐️", "callback_data": "rate_9"},
                    {"text": "10⭐️", "callback_data": "rate_10"},
                ]],
            })
            send_json_api(
                "sendMessage",
